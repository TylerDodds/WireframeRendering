...
Shader "Hidden/PixelinearAccelerator/Wireframe/URP Wireframe Unlit (Using Mesh Quads)"
{
	Properties
	{
		[Header(Size)]
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma target 5.0//For GATHER_RED operation
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma prefer_hlslcc gles
			#pragma only_renderers d3d11_9x gles
